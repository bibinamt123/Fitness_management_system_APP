...
def \
    ...
    with tf.compat.v1.Session(graph=graph) as sess:
        ...
        output_graph_def = tf.compat.v1.graph_util.convert_variables_to_constants(
                sess, graph.
                as_graph_def(), [FLAGS.final_tensor_name])
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--summaries_dir',
        type=str,
        default='C:\\Users\\bibin\\Music\\GYMGUIDE\\GYMGUIDE\\trainingdata\\retrain_new_logs',
        help='Where to save summary new_logs for TensorBoard.'
        )
    parser.add_argument(
    ...
    parser.add_argument(
        '--model_dir',
        type=str,
        default='C:\\Users\\bibin\\Music\\GYMGUIDE\\GYMGUIDE\\trainingdata\\',
        help="""\
