...
class MyChatApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const MyChatNew(title: 'Flutter Demo Home Page'),
    );
  }
}

class MyChatNew extends StatefulWidget {
  const MyChatNew({super.key, required this.title});

  final String title;

  @override
  State<MyChatNew> createState() => _MyChatNewState();
}
...
class _MyChatNewState extends State<MyChatNew> {
  int _counter = 0;
  String name = "";
  ...
  Future<void> view_message() async {
    ...
    try {
      ...
      var data = await http.post(Uri.parse(url), body: {
        ...
        'to_id': pref.getString("tid").toString()
      });
